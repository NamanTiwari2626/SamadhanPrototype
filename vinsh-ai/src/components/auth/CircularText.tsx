...
const CircularText: React.FC<CircularTextProps> = ({
  ...
  // Increase readability by enlarging circle and spacing letters on a true circle
    ...
    >
      {letters.map((letter, i) => {
        ...
        return (
          <span
            key={i}
            className="absolute inline-block text-3xl transition-all duration-500 ease-[cubic-bezier(0,0,0,1)]"
            style={{
              transform,
