...
const TrueFocus: React.FC<TrueFocusProps> = ({
  sentence = "VINSH-AI Study smarter, achieve higher",
  manualMode = false,
  blurAmount = 5,
  borderColor = "#E50914",
  ...
  return (
    <div className="relative flex gap-4 justify-center items-center flex-wrap" ref={containerRef}>
      {words.map((word, index) => {
        ...
        return (
          <span
            ...
            className="relative text-[2.25rem] md:text-[3rem] font-black cursor-pointer select-none"
            style={{
      ...
      <motion.div
        ...
        style={{
          // CSS variables for the corner borders and glow
